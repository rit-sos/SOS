...
define hook-stop
  ...
  if $cs == 16 || $cs == 27
    if $lastcs != 16 && $lastcs != 27
      set architecture i386
    end
    x/i $pc
  else
    if $lastcs == -1 || $lastcs == 16 || $lastcs == 27
...
echo + symbol-file bootstrap.o kernel.o init.o user_a.o\n
symbol-file bootstrap.o kernel.o init.o user_a.o
